                ...
                <div className="course-header-div">
                    <Fade bottom duration={2000} distance="20px">
                        ...
                        <h1 className="course-text2" style={{ color: theme.text }}>
                            ...
                            was in my opinion a great idea because it could be adapted to every background.
                            The fact that we were able to produce a state-of-the-art gas sensor was extremely impressive to me and
